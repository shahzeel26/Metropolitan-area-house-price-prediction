...
def bangalore():
    st.title('''Bangalore city's house price prediction''')

    c=pd.read_csv('D:\zeel\projects\metropolitian_house_price_prediction\Bangalore.csv')
    # st.write(c.head())
    ...
    'Type or select a area from the dropdown',
    d[4:])
